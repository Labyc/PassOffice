...
public class PassportRFForeignPostDTO extends BasePassportPostDTO {
    ...
    public PassportRFForeignPostDTO(@NotNull PassportType passportType, @NotNull String personId, @NotNull String number, @PastOrPresent LocalDate givenDate, @NotNull @Pattern(regexp = "\\p{Upper}\\w*") String givenDepartment, List<String> otherPassportIds) {
